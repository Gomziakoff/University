...
from PySide6.QtWidgets import (QApplication, QFileDialog, QHBoxLayout,
                               ...
                               QTextEdit, QVBoxLayout, QWidget, QDialog, QLabel)
...
class DetailDialog(QDialog):
    ...
    def __init__(self, row, column, parent=None):
        ...
        # Получаем данные из родительского виджета
        if parent:
            details = parent.get_row_data(row)  # Используем метод родителя
        else:
            details = {}
...
class MainWindow(QMainWindow):
    ...
    def process_text(self):
        ...
        if text:
            ...
            sorted_lemmas = self.text_processor.process_text(words,text)
    ...
    def update_table(self, sorted_lemmas):
        ...
        for lemma_info in sorted_lemmas:
            ...
            self.table.setItem(row_position, 0, QTableWidgetItem(lemma_info["word"]))  # Лексема
