...
if __name__ == '__main__':
    ...
    # Data arguments
    parser.add_argument('--dataset', type=str.lower, default='mnist', choices=['mnist', 'fashionmnist', 'usps', 'anime'], help='dataset to use')
    ...
    parser.add_argument('--z_dim', type=int, default=256, help='sample noise dimensions')
