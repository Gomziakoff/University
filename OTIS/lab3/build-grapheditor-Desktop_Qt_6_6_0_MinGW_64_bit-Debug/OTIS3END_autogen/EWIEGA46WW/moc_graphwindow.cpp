...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGraphWindowENDCLASS_t qt_meta_stringdata_CLASSGraphWindowENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(581, 17),  // "getSelectedVertex"
        QT_MOC_LITERAL(599, 7),  // "addEdge"
        QT_MOC_LITERAL(607, 7),  // "Vertice"
        QT_MOC_LITERAL(615, 5),  // "vert1"
        QT_MOC_LITERAL(621, 5),  // "vert2"
        QT_MOC_LITERAL(627, 4),  // "Edge"
        QT_MOC_LITERAL(632, 4),  // "edge"
        QT_MOC_LITERAL(637, 9),  // "addOrEdge"
        QT_MOC_LITERAL(647, 6)   // "OrEdge"
    },
    "GraphWindow",
    "on_addVertPushButton_clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGraphWindowENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      ...
      14,    3,  166,    2, 0x08,   11 /* Private */,
      18,    0,  173,    2, 0x08,   15 /* Private */,
      19,    0,  174,    2, 0x08,   16 /* Private */,
      20,    0,  175,    2, 0x08,   17 /* Private */,
      21,    1,  176,    2, 0x08,   18 /* Private */,
      23,    0,  179,    2, 0x08,   20 /* Private */,
      24,    0,  180,    2, 0x08,   21 /* Private */,
      25,    1,  181,    2, 0x08,   22 /* Private */,
      26,    0,  184,    2, 0x08,   24 /* Private */,
      28,    0,  185,    2, 0x08,   25 /* Private */,
      29,    0,  186,    2, 0x08,   26 /* Private */,
      30,    0,  187,    2, 0x08,   27 /* Private */,
      31,    2,  188,    2, 0x08,   28 /* Private */,
      31,    1,  193,    2, 0x28,   31 /* Private | MethodCloned */,
      35,    0,  196,    2, 0x08,   33 /* Private */,
      36,    3,  197,    2, 0x08,   34 /* Private */,
      42,    3,  204,    2, 0x08,   38 /* Private */,
 ...
 // slots: parameters
    ...
    0x80000000 | 7,
    QMetaType::Void, 0x80000000 | 37, 0x80000000 | 37, 0x80000000 | 40,   38,   39,   41,
    QMetaType::Void, 0x80000000 | 37, 0x80000000 | 37, 0x80000000 | 43,   38,   39,   41,
...
Q_CONSTINIT const QMetaObject GraphWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGraphWindowENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<bool, std::false_type>,
        QtPrivate::TypeAndForceComplete<const VEC2 &, std::false_type>,
        // method 'getSelectedVertex'
        QtPrivate::TypeAndForceComplete<QGraphicsEllipseItem *, std::false_type>,
        // method 'addEdge'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<Vertice, std::false_type>,
        QtPrivate::TypeAndForceComplete<Vertice, std::false_type>,
        QtPrivate::TypeAndForceComplete<Edge, std::false_type>,
        // method 'addOrEdge'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<Vertice, std::false_type>,
        QtPrivate::TypeAndForceComplete<Vertice, std::false_type>,
        QtPrivate::TypeAndForceComplete<OrEdge, std::false_type>
    >,
    nullptr
} };
...
void GraphWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 19: { bool _r = _t->isTree((*reinterpret_cast< std::add_pointer_t<VEC2>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 20: { QGraphicsEllipseItem* _r = _t->getSelectedVertex();
            if (_a[0]) *reinterpret_cast< QGraphicsEllipseItem**>(_a[0]) = std::move(_r); }  break;
        case 21: _t->addEdge((*reinterpret_cast< std::add_pointer_t<Vertice>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<Vertice>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<Edge>>(_a[3]))); break;
        case 22: _t->addOrEdge((*reinterpret_cast< std::add_pointer_t<Vertice>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<Vertice>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<OrEdge>>(_a[3]))); break;
        default: ;
        }
